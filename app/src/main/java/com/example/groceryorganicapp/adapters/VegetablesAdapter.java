...
public class VegetablesAdapter extends RecyclerView.Adapter<VegetablesAdapter.ViewHolder> {
    ...
    public VegetablesAdapter(List<SeachRVModel> list, Context context) {
        this.list = list;
    ...
    @Override
    public void onBindViewHolder(@NonNull VegetablesAdapter.ViewHolder holder, int position) {
    ...
    public List<AddToCart> getVegAddToCart()
    {
